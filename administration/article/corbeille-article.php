...
$tso_listrs_article6->setDefault("libelle_art");
...
$query_rs_article = sprintf("SELECT * FROM article WHERE idrub_art = %s AND  {$NXTFilter_rs_article} AND  {$NXTFilter_rs_article} AND  {$NXTFilter_rs_article}   AND  geler_art=1 ORDER BY {$NXTSort_rs_article} ", GetSQLValueString($colname_rs_article, "int"));
...
if (@$_GET['idrub_art'] == 4) {
?>
<th id="image5_art" class="KT_sorter KT_col_image5_art <?php echo $tso_listrs_article6->getSortIcon('image5_art'); ?>"> <a href="<?php echo $tso_listrs_article6->getSortLink('image5_art'); ?>">Image5</a> </th>
...
if (@$_GET['idrub_art'] == 1) {
?>
<td><div class="KT_col_texte_art"><?php echo KT_FormatForList($row_rs_article['texte_art'], 20); ?></div></td>
<?php } 
// endif Conditional region4
?>
...
if (@$_GET['idrub_art'] == 3 || @$_GET['idrub_art'] == 4) {
?>
<td><div class="KT_col_image2_art">
  <?php 
// Show If File Exists (region36)
if (tNG_fileExists("../../assets/image/", "{rs_article.image2_art}")) {
?>
    <img src="<?php echo tNG_showDynamicImage("../../", "../../assets/image/", "{rs_article.image2_art}");?>" width="100" height="70" />
    <?php 
// else File Exists (region36)
} else { ?>
    Aucune image
  <?php } 
// EndIf File Exists (region36)
?></div></td>
<?php } 
// endif Conditional region4
?>
...
if (@$_GET['idrub_art'] == 4) {
?>
 <td><div class="KT_col_image3_art">
   <?php 
// Show If File Exists (region37)
if (tNG_fileExists("../../assets/image/", "{rs_article.image3_art}")) {
?>
     <img src="<?php echo tNG_showDynamicImage("../../", "../../assets/image/", "{rs_article.image3_art}");?>" width="100" height="70"/>
     <?php 
// else File Exists (region37)
} else { ?>
     Aucune image
  <?php } 
// EndIf File Exists (region37)
?></div></td>
<?php } 
// endif Conditional region4
?>
...
if (@$_GET['idrub_art'] == 4) {
?>
<td><div class="KT_col_image4_art">
  <?php 
// Show If File Exists (region38)
if (tNG_fileExists("../../assets/image/", "{rs_article.image4_art}")) {
?>
    <img src="<?php echo tNG_showDynamicImage("../../", "../../assets/image/", "{rs_article.image4_art}");?>" width="100" height="70"/>
    <?php 
// else File Exists (region38)
} else { ?>
    Aucune image
  <?php } 
// EndIf File Exists (region38)
?></div></td>
<?php } 
// endif Conditional region4
?>
...
<td><div class="KT_col_image5_art">
  <?php 
// Show If File Exists (region39)
if (tNG_fileExists("../../assets/image/", "{rs_article.image5_art}")) {
?>
    <img src="<?php echo tNG_showDynamicImage("../../", "../../assets/image/", "{rs_article.image5_art}");?>" width="100" height="70"/>
    <?php 
// else File Exists (region39)
} else { ?>
    Aucune image
  <?php } 
// EndIf File Exists (region39)
?></div></td>
...
<div>
<a href="../master.php?page=liste-article&amp;idrub_art=<?php echo $_GET['idrub_art']; ?>">Retour</a>
</div>
</body>
</body>
</html>
