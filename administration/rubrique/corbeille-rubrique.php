...
$query_rs_rubrique = sprintf("SELECT * FROM rubrique WHERE idrub_rub = %s AND  {$NXTFilter_rs_rubrique} AND rubrique.geler_rub=1 ORDER BY {$NXTSort_rs_rubrique} ", GetSQLValueString($colname_rs_rubrique, "int"));
...
?></div></td>
                ...
                <a class="" href="../master.php?page=restaurer-rubrique&amp;id_rub=<?php echo $row_rs_rubrique['id_rub']; ?>">Restaurer</a>&nbsp;
                </td>
              </tr>
...
<p>&nbsp;</p>
<div><a href="../master.php?page=liste-rubrique&amp;idrub_rub=<?php echo $_GET['idrub_rub']; ?>">Retour</a></div>
</body>
</html>
<?php
