...
$customTransaction->registerTrigger("END", "Trigger_Default_Redirect", 99, "./master.php?page=corbeille-rubrique&idrub_rub=5");
// Set custom transaction SQL
$customTransaction->setSQL("UPDATE `datacollector_db`.`rubrique` SET `geler_rub` = '0' WHERE `rubrique`.`id_rub` ={GET.id_rub};");
// Add columns
